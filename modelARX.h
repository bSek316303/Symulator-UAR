...
public:
    ...
    void set_ograniczenie_sterowania(bool czy_wlaczone);
    void set_ograniczenie_wyjscia(bool czy_wlaczone);
    ...
    void set_sterowanie_max(double sterowanie_max_p)
    {
        sterowanie_max = sterowanie_max_p;
    }
    void set_wyjscie_min(double wyjscie_min_p)
    {
    ...
    void set_opoznienie(int opoznienie_p);
